    ...
    <div id="projects" className="w-full ">
      <div className="max-w-screen-xl mx-auto px-8 text-center">
        <p className="flex flex-row justify-center items-center">
          ...
          <a href="https://www.linkedin.com/in/zwelihle-masango-2750081b4/" className="mx-4 hover:text-blue-500"><FaLinkedin size={25} className="hover:text-[#0072b1]"/></a>
          <a href="https://github.com/Zwelihle-M" className="mx-4 "><FaGithub size={25}/></a>
          <a href="https://www.youtube.com/" className="mx-4 hover:text-[#FF0000]"><FaYoutube size={30} /></a>
        </p>
