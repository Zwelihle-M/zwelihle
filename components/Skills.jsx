      ...
      <motion.div className="grid grid-cols-4 gap-5 pt-24 ">
        {skills.map(({ id, title, src, description }) => (
          ...
          >
            ...
            <div className="absolute opacity-0 group-hover:opacity-80 transition duration-300 ease-in-out rounded-full z-0 group-hover:bg-gradient-to-bl from-purple-800 to-fuchsia-800 h-24 w-24 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
              <div className="flex items-center justify-center h-full text-center">
                <p className="text-lg opacity-100 text-white ">
                  {description}
                </p>
              </div>
            </div>
